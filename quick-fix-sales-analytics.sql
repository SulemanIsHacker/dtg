-- Quick fix for sales analytics functions
-- Run this in Supabase SQL Editor to fix the function type mismatch

-- Drop existing functions with any parameter signature
...
-- Quick test
SELECT COUNT(*) as sales_records FROM get_sales_analytics('2024-01-01'::DATE, '2024-12-31'::DATE, 'daily');
SELECT COUNT(*) as product_records FROM get_product_sales_summary('2024-01-01'::DATE, '2024-12-31'::DATE);
