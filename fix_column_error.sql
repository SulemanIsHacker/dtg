-- Fix the column error
-- Check if phone_number column exists and create function accordingly
...
-- Step 2: If phone_number column doesn't exist, add it
ALTER TABLE user_auth_codes 
ADD COLUMN IF NOT EXISTS phone_number VARCHAR(20);

-- Step 3: Drop all existing function versions
...
-- Step 4: Create function that handles missing columns gracefully
...
DECLARE
    ...
    v_product_code TEXT;
    v_product_name TEXT;
    v_phone_column_exists BOOLEAN := false;
BEGIN
    ...
    ELSE
        ...
        -- Insert user with or without phone number
        IF v_phone_column_exists THEN
