-- IMMEDIATE FIX: Make code column nullable and fix function
-- This will resolve the null constraint violation immediately

-- Step 1: Make the code column nullable to avoid constraint violations
...
BEGIN
    ...
    LOOP
        ...
        -- Generate product code using simple method
        v_product_code := 'PC' || EXTRACT(EPOCH FROM NOW())::BIGINT || v_counter;
