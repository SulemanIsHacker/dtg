-- IMMEDIATE CHECKOUT FIX
-- Run this in your Supabase SQL Editor to fix the checkout issue
...
BEGIN
    ...
    LOOP
        ...
        -- Generate product code using timestamp + counter (NEVER NULL)
        ...
        INSERT INTO product_codes (
            ...
            v_product_code,  -- This will NEVER be NULL
            v_user_auth_code_id,
