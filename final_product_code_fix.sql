-- IMMEDIATE FIX: Correct product_code column usage
-- This fixes the NOT NULL constraint violation by using the correct column name

-- Step 1: Drop all existing function versions
...
-- Step 2: Create the corrected function with proper column name
