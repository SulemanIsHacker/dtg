-- ROBUST FIX: Ensure product_code is never NULL
-- This fixes the NOT NULL constraint violation with better validation
...
-- Step 2: Create the corrected function with robust product_code generation
