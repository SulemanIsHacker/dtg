-- IMMEDIATE FIX: Update database function to match frontend
-- This will fix the checkout error immediately

-- Drop all existing versions of create_simple_purchase function
...
-- Create the correct function with 3 parameters (no phone number)
